...
def scrape_elsevier_cfp(url, subject_name):
    ...
    # Set up the driver (this example uses Chrome)
    ...
    for publication in publications:
        title_tag = publication.find('a', {'class': 'anchor js-publication-title anchor-default'})
        title = title_tag.text.strip() if title_tag else None

        description_tag = publication.find('p', {'class': 'publication-text'})
        ...
        url = 'https://www.sciencedirect.com' + publication.find('a', {'class': 'anchor js-publication-title anchor-default'})['href'] if title_tag else None
        clickable_url = f'<a href="{url}" target="_blank">Link</a>'

        # Add Kiadó and Filter as static values
        kiado = "<img src='https://sdfestaticassets-eu-west-1.sciencedirectassets.com/shared-assets/24/images/elsevier-non-solus-new-grey.svg' width='50px' height='50px'>"
        filter_value = subject_name
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="h-8 w-8 rounded-full" src="pictures/SzSzG-profile-picture.jpg" alt="">
                  </button>
                </div>
